...
class Mhs {
  ...
  Mhs({this.nip, this.nama_pegawai, this.departemen, this.jabatan, this.pendidkan_terakhir});

  factory pegawai.fromJson(Map<String, dynamic> json) {
    return Mhs(
      nim: json['nip'] as String,
      nama: json['nama_pegawai'] as String,
      kelas: json['departemen'] as String,
      kdmatkul: json['jabatan'] as String,
      email: json['pendidikan_terakhir'] as String,
    );
  }
}
